...
class _SessionBase(object):
    ...
    **Defined Values**:
    ...
    +----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | ExportOutputTerminal.PXIE_DSTARC | The trigger is received on the PXIe DStar B trigger line. This value is valid on only the PXIe-5820/5830/5831/5832/5840/5841.                                                   |
    +----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    ...
    **High-Level Methods**:
    ...
    | NIRFSA_VAL_DO_NOT_EXPORT         | The signal is not exported.                                                                                                                                        |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_CLK_OUT               | The signal is exported to the CLK OUT connector on the PXIe-5622/5624 front panel.                                                                                 |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_REF_OUT               | The signal is exported to the REF IN/OUT terminal on the PXI/PXIe-5652 and the REF OUT terminal on the PXIe-5644/5645/5646 and PXIe-5820/5830/5831/5832/5840/5841. |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_REF_OUT2              | The signal is exported to the REF OUT2 terminal on the LO. This connector exists only on the PXIe-5652.                                                            |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PFI0                  | The signal is exported to the PFI 0 connector. For the PXIe-5841 with PXIe-5655, the signal is exported to the PXIe-5841 PFI 0.                                    |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PFI1                  | The signal is exported to the PFI 1 connector on the PXI-5142 and PXIe-5622.                                                                                       |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_TRIG0             | The signal is exported to the PXI trigger line 0.                                                                                                                  |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_TRIG1             | The signal is exported to the PXI trigger line 1.                                                                                                                  |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_TRIG2             | The signal is exported to the PXI trigger line 2.                                                                                                                  |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_TRIG3             | The signal is exported to the PXI trigger line 3.                                                                                                                  |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_TRIG4             | The signal is exported to the PXI trigger line 4.                                                                                                                  |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_TRIG5             | The signal is exported to the PXI trigger line 5.                                                                                                                  |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_TRIG6             | The signal is exported to the PXI trigger line 6.                                                                                                                  |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_TRIG7             | The signal is exported to the PXI trigger line 7.                                                                                                                  |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_PXI_STAR              | The signal is exported to the PXI star trigger line.                                                                                                               |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | ExportOutputTerminal.PXIE_DSTARC | The trigger is received on the PXIe DStar C trigger line. This value is valid on only the PXIe-5820/5830/5831/5832/5840/5841.                                      |
    +----------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
    | NIRFSA_VAL_DIO_PFI0              | The trigger is received on PFI0 from the front panel DIO terminal.                                                                                                 |
