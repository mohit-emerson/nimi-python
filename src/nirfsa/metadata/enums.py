...
enums = {
    ...
    'RfPreselectorFilter': {
        ...
        'values': [
            {
                'documentation': {
                    'description': 'Specifies that no preselector path is used.'
                },
                'name': 'NIRFSA_VAL_RF_PRESELECTOR_FILTER_PATH_NONE',
                'value': 3300
            },
            {
                'documentation': {
            ...
            {
                'documentation': {
                    'description': 'Specifies that the 20 MHz to 3.04 GHz external filter filter path is used.'
                },
                'name': 'NIRFSA_VAL_RF_PRESELECTOR_FILTER_PATH_EXTERNAL_FILTER',
                'value': 3317
            }
        ]
    },
