<%page args="results_name='spectrum_info', results_description='spectrums', output_name='spectrum_info', start_record_variable='0'"/>\
<%
    '''Sub-template to populate channel and record info for a spectrum in a fetch method.'''
%>\
        ...
        spectrum_info_type._populate_channel_and_record_info(${output_name}, channel_names, range(${start_record_variable}, ${start_record_variable} + actual_num_records))