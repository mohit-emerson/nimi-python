<%page args="results_name='wfm_info', results_description='waveforms', output_name='wfm_info', start_record_variable='starting_record'"/>\
<%
...
%>\
        ...
        waveform_info._populate_channel_and_record_info(${output_name}, channel_names, range(${start_record_variable}, ${start_record_variable} + actual_num_records))